...
public class BookmarkCompanyAdapter extends RecyclerView.Adapter<BookmarkCompanyAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(@NonNull ViewHolder viewHolder, int i) {
        ...
        viewHolder.btnRemove.setOnClickListener(v -> listener
                .onClickToRemove(data.get(i).getTargetId(), data.get(i).getTargetName(), i));
        viewHolder.btnDetail.setOnClickListener(v -> listener
